...
export default function Mission() {
    ...
    return (
        <Flex width={{ base: '90%', md: '60%' }} flexDir={'column'} gap={4}>
            ...
            <Box>
                Fractal Fantasy is building on the concept of Play-to-Earn (P2E) and
            ...
            <Box>
                ...
                improve the health and well-being of gamers. Currently, there are only 1-2 million P2E gamers and 2.7 billion gamers
                worldwide.
